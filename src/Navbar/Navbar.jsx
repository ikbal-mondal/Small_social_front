...
export const Navbar = () => {
    ...
    return (
      <div className="fixed top-0 z-20 bg-base-200 left-0 right-0 w-full px-4 py-5 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8">
          ...
          <ul className="flex items-center hidden space-x-8 lg:flex">
            <li>
              ...
              >
                ...
                <i className="fa-solid mr-2 fa-house"></i>
                Home
              </Link>
            </li>
            <li>
              ...
              >
                ...
                <i className="fa-solid mr-2 fa-square-plus"></i>
                Create Post
              </Link>
            </li>
            <li>
              ...
              <i className="fa-solid mr-2 fa-photo-film"></i> 
              Media
              </Link>
            </li>
          
            {
              ...
              <a
                ...
                className="font-medium tracking-wide text-gray-700 transition-colors duration-200 hover:text-deep-purple-accent-400"
              >
                <i className="fa-solid mr-2 fa-user-tie"></i>
                About Me
              </a>
            </li>
            }
